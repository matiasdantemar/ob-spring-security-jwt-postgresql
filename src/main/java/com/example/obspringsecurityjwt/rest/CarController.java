...
public class CarController {
     ...
     */
    @GetMapping("/cars/{id}")
    @Operation(summary = "Buscar coche por id")

    public ResponseEntity<Car> findById(@Parameter(description = "Clave primaria car") @PathVariable Long id) {
...
//				);
    ...
    // @ApiIgnore
    @Operation(summary = "Buscar coches filtrando por numero puertas")
